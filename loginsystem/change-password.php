            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-2"><i class="fa fa-user-circle" aria-hidden="true"></i>Change Password</h1>
                        <div class="card mb-4">
                     <form method="post" name="changepassword" onSubmit="return valid();">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-warning btn-block" name="update"><i class="fa fa-user-cog" aria-hidden="true"></i>Change</button></td>
