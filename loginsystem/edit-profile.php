...
{?>
                        <h1 class="mt-4"><i class="fa fa-user-circle" aria-hidden="true"></i><?php echo $result['fname'];?><b style="color:orange">'s Profile</h1>
                        <div class="card mb-4">
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-warning" name="update"><i class="fa fa-fw fa-edit"></i>Update</button></td>
