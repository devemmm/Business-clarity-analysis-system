...
{?>
                        <h1 class="mt-3"><i class="fa fa-user-circle"></i><?php echo $result['fname'];?><b style="color
                        :orange;">'s Profile</h1>
                        <div class="card mb-4">
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-warning btn-block" name="update"><i class="fa fa-user-edit"></i>Update</button></td>
