   	...
   	<div class="container">
		<div class="card">
			<div class="card-header">
				...
				<a href="dashboard.php" class="float-right btn btn-dark btn-sm">
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="edit-usersadmin.php?editId=<?php echo $val['id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
